# -*- coding: utf-8 -*-
"""
This project scrapes movie data with specific interest in the IMDB and Metacritic ratings from the website IMDB.

"""
# Needed imports for successful running of the file. 
import pandas as pd
import requests
